    ...
    public class Scraper
    {
        ...
        public bool newWorldScrap(string str, string root_dir, string storeUrl, string postcode, string file_name)
        {
            ...
            try
            {
                ...
                int pageCnt = Int32.Parse(pageNum);
                log("12");
                ...
                {
                    strArray3 = startDate.Trim().Split('/');
                    strArray4 = endDate.Trim().Split('/');
                }
                ...
                for (int i = 1; i < pageCnt + 1; i++)
                {
                    try
                    {
                        string item_Url = "http://app.redpepperdigital.net/catalogue/" + categoryId + "/page/" + i.ToString() + "/regions/json";
                        ...
                        foreach (dynamic cat_item in content1)
                        {
                            ...
                            else if (item_name.Contains("Range"))
                            {
                                log("40");
                                item_name = item_name.Replace("Range", "");
                            }
                            else if (item_name.Contains("selected"))
                            {
                                log("41");
                                item_name = item_name.Replace("selected", "");
                            }
                            else if (item_name.Contains("Selected"))
                            {
                                log("42");
                            ...
                            else if (item_name.Contains("- from the deli dept"))
                            {
                                log("43");
                                item_name = item_name.Replace("- from the deli dept", "");
                            }
                            else if (item_name.Contains("– From the Deli"))
                            {
                                log("44");
                                item_name = item_name.Replace("– From the Deli", "");
                            }
                            if (item_name.Contains("é"))
                            {
                                log("45");
                            ...
                            if (item_name.Contains("Varieties"))
                            {
                                log("49");
                                item_name = item_name.Replace("Varieties", "");
                            ...
                            item_name = item_name.Replace("  ", " ");
                            item_name = item_name.Replace("ü", "u");
                            ...
                            log("65");
                            downloadPdf(pdf_falePath, root_dir + "//" + file_name + "_" + fileDate + ".pdf");
                            log("66");
